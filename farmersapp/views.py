...
def create_category(request):
    if request.method == 'POST':
        ...
        form = CategoryForm()
    return render(request, 'farmersapp/category_form.html', {'form': form})
...
def login(request):
    ...
    if request.method == 'POST':
        ...
        form = LoginForm()
    return render(request, 'farmersapp/login.html', {'form': form})
...
def create_area(request):
    if request.method == 'POST':
        ...
        form = AreaForm()
    return render(request, 'farmersapp/area_form.html', {'form': form})
...
def create_equipment(request):
    ...
    if request.method == 'POST':
        ...
        form = EquipmentForm()
    return render(request, 'farmersapp/equipment_form.html', {'form': form})
...
class Update_weather:
    logger.info('Updating weather started')
